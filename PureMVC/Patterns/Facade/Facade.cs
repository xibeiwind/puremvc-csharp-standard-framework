...
namespace PureMVC.Patterns.Facade
{
    ...
    ///         <item>
    ///             Providing the ability to override the specific <c>Model</c>, <c>View</c> and <c>Controller</c> Singletons
    ///             created.
    ///         </item>
    ///         <item>
    ///             Providing a single point of contact to the application for registering <c>Commands</c> and notifying
    ///             <c>Observers</c>
    ///         </item>
    ///     </list>
    /// </remarks>
    ...
    public class Facade : IFacade
    {
        ...
        ///             <item>
        ///                 You have <c>Proxy</c>s to register with the <c>Model</c> that do not
