...
namespace PureMVC.Core
{
    ...
    /// <remarks>
    ///     <para>
    ///         In PureMVC, the <c>Controller</c> class follows the
    ...
    public class Controller : IController
    {
        ...
        {
            if (commandMap.TryRemove(notificationName, out _)) view.RemoveObserver(notificationName, this);
        }
        ...
        {
            if (instance == null) instance = controllerFunc();
            return instance;
        }
    }
}