...
namespace PureMVC.Core
{
    ...
    public class View : IView
    {
        ...
        public virtual void NotifyObservers(INotification notification)
        {
            ...
            if (observerMap.TryGetValue(notification.Name, out var observers_ref))
            {
                ...
                foreach (var observer in observers) observer.NotifyObserver(notification);
            }
        }
        ...
        public virtual void RegisterMediator(IMediator mediator)
        {
            ...
            if (mediatorMap.TryAdd(mediator.MediatorName, mediator))
            {
                ...
                if (interests.Length > 0)
                {
                    ...
                    for (var i = 0; i < interests.Length; i++) RegisterObserver(interests[i], observer);
                }
        ...
        {
            if (instance == null) instance = viewFunc();
            return instance;
        }
    }
}