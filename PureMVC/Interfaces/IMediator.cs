...
namespace PureMVC.Interfaces
{
    ...
    ///         <list type="bullet">
    ///             <item>
    ///                 Implement a common method which returns a list of all <c>INotification</c>s
    ///                 the <c>IMediator</c> has interest in.
    ///             </item>
    ...
    ///             </item>
    ///             <item>
    ///                 Respond to and generate <c>INotifications</c>, interacting with of
